...
/**
 * Represents the implementation of minimum spanning tree algorithms
...
public class MinimumSpanningTreeUtil {
	 ...
	 * @return a list of the minimum spanning tree
	 */
    public static <V, E extends Weighted> PositionalList<Edge<E>> kruskal(Graph<V, E> g) {
    	PositionalList<Edge<E>> tree = new PositionalLinkedList<Graph.Edge<E>>();
    	PriorityQueue<Integer, Edge<E>> pq = new HeapPriorityQueue<Integer, Graph.Edge<E>>();
    ...
    /**
     * An implementation of Prim-Jarnik's algorithm
     * @param <V> vertex of graph
     * @param <E> edge of graph
     * @param g graph to evaluate
     * @return a list of the minimum spanning tree
