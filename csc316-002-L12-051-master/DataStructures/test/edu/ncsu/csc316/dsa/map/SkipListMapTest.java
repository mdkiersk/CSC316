...
public class SkipListMapTest {
	...
	public void testStudentMap() {
		...
		assertEquals("SkipListMap[J K, 1, J S, 2]", studentMap.toString());
		
		studentMap.put(s4, 100);
		assertEquals(3, studentMap.size());
		assertEquals("SkipListMap[J J, 4, J K, 1, J S, 2]", studentMap.toString());
		
		studentMap.put(s5, 100);
		assertEquals(4, studentMap.size());
		assertEquals("SkipListMap[L B, 5, J J, 4, J K, 1, J S, 2]", studentMap.toString());
		
		studentMap.put(s3, 100);
		assertEquals(5, studentMap.size());
		assertEquals("SkipListMap[L B, 5, S H, 3, J J, 4, J K, 1, J S, 2]", studentMap.toString());
		
		//Test with id comparator
		Comparator<Student> comparator = new StudentIDComparator();
		studentMap = new SkipListMap<Student, Integer>(comparator);
		
		studentMap.put(s3, 100);
		assertEquals(1, studentMap.size());
		assertEquals("SkipListMap[S H, 3]", studentMap.toString());
		
		studentMap.put(s1, 100);
		assertEquals(2, studentMap.size());
		assertEquals("SkipListMap[J K, 1, S H, 3]", studentMap.toString());
		
		studentMap.put(s2, 100);
		assertEquals(3, studentMap.size());
		assertEquals("SkipListMap[J K, 1, J S, 2, S H, 3]", studentMap.toString());
		
		studentMap.put(s5, 100);
		assertEquals(4, studentMap.size());
		assertEquals("SkipListMap[J K, 1, J S, 2, S H, 3, L B, 5]", studentMap.toString());
		
		studentMap.put(s4, 100);
		assertEquals(5, studentMap.size());
		assertEquals("SkipListMap[J K, 1, J S, 2, S H, 3, J J, 4, L B, 5]", studentMap.toString());
	}
