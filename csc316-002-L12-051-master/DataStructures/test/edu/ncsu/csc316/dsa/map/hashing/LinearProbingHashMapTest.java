...
public class LinearProbingHashMapTest {
    ...
    /**
     * Sets map to a new LinearProbingHashMap, setting capacity to seven and isTesting to true
     * Sets defaultMap to a new LinearProbingHashMap, setting capacity to default and isTesting to false
     * Sets customCapacityMap to a new LinearProbingHashMap, setting capacity to 3 and isTesting to false
     */
    @Before
    public void setUp() {
        ...
        defaultMap = new LinearProbingHashMap<Integer, String>();
        
        customCapacityMap = new LinearProbingHashMap<Integer, String>(3);
    }
