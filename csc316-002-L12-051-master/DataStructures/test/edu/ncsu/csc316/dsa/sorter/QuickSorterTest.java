...
public class QuickSorterTest {
	...
	public static final FirstElementSelector FIRST_ELEMENT_SELECTOR = new FirstElementSelector();
	/** Instance of the selector that uses the last element as a pivot */
	public static final LastElementSelector LAST_ELEMENT_SELECTOR = new LastElementSelector();
	/** Instance of the selector that uses the middle element as a pivot */
	public static final MiddleElementSelector MIDDLE_ELEMENT_SELECTOR = new MiddleElementSelector();
	...
	/**
	 * Tests sort() method using random element as pivot
	 */
	@Test
	...
	/**
	 * Tests sort() using the first element as a pivot
	 */
	@Test
	public void testSortFirstElement() {
		integerSorter = new QuickSorter<Integer>(FIRST_ELEMENT_SELECTOR);
	...
	/**
	 * Tests sort() using last element as a pivot
	 */
	@Test
	public void testSortLastElement() {
		integerSorter = new QuickSorter<Integer>(LAST_ELEMENT_SELECTOR);
	...
	/**
	 * Tests sort using middle element as a pivot
	 */
	@Test
	public void testSortMiddleElement() {
		integerSorter = new QuickSorter<Integer>(MIDDLE_ELEMENT_SELECTOR);
	...
	public void testSortStudent() {
		...
		studentSorter = new QuickSorter<Student>(studentGPAComparator);
		...
		studentSorter = new QuickSorter<Student>(studentIDComparator);
